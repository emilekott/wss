 ...
 * @version $Id: attributes_controller.php 6131 2007-04-08 06:56:51Z drbyte $
 */
...
// validation no longer required, as improved attributes controller ensures valid matches
/*
          if (!zen_validate_options_to_options_value($_POST['options_id'], $_POST['values_id'][$i])) {
...
// when set to none remove from database
          ...
          } // end if ($attributes_image->parse() && $attributes_image->save($_POST['overwrite']))
...
?>
TCN_addContent("<?php echo $attributes->fields['products_options_name']; ?>+#+<?php echo $attributes->fields['products_options_id']; ?>+#+<?php echo $products_options_values_name; ?>+#+<?php echo $attributes->fields['products_options_values_id']; ?>");
<?php 
$attributes->MoveNext();
}
?>
