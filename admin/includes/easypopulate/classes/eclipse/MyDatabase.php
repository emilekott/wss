 ...
 * </p>
 ***/
class eclipseMyDatabase extends eclipseDatabase
{
    // CREATORS
     ...
     ***/
    function eclipseMyDatabase($name, $host = '')
    {
        $this->eclipseDatabase($name, $host);
    }
    ...
    function &query($sql)
    {
    	$result =& new eclipseMyQueryResult($this, mysql_query($sql, $this->getLink()));
      return $result;
    }
    ...
    function &createTransaction()
    {
        ...
        $transaction =& new MyTransaction($this);
        return $transaction;
    }
 ...
 * @see MyDatabase
 ***/
class eclipseMyQueryResult extends eclipseQueryResult
{
    // DATA MEMBERS
    ...
    function eclipseMyQueryResult(&$database, $resultId)
    {
        $this->eclipseQueryResult($database, $resultId);
        $this->currentRow   = 0;
