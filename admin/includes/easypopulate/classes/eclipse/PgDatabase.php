 ...
 * </p>
 ***/
class eclipsePgDatabase extends eclipseDatabase
{
    // CREATORS
     ...
     ***/
    function eclipsePgDatabase($name, $host = '')
    {
    ...
    function &query($sql)
    {
        return new eclipsePgQueryResult($this, pg_query($this->getLink(), $sql));
    }
 ...
 * @see PgDatabase
 ***/
class eclipsePgQueryResult extends eclipseQueryResult
{
    // DATA MEMBERS
