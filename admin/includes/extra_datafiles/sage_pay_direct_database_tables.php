...
/**
 * sage_pay_direct Database Table Name Definition
 *
 ...
 * @version    $Id: sage_pay_direct_database_tables.php 385 2009-06-23 11:11:45Z Bob $
 */

if (!defined('DB_PREFIX')) {
    define('DB_PREFIX', '');
}
define('TABLE_SAGE_PAY_DIRECT', DB_PREFIX . 'sage_pay_direct');
