...
define('TABLE_ADVANCED_SHIPPER_METHOD_ADMIN_TITLES', DB_PREFIX . 'advshipper_method_admin_titles');
...
define('TABLE_ADVANCED_SHIPPER_REGION_ADMIN_TITLES', DB_PREFIX . 'advshipper_region_admin_titles');
