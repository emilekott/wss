        ...
        <div class="footer-map">
            <ul>
                ...
                foreach ($topcats as $cat_id => $cat):
                    ?>
                    <li class="top-level">
                        <a href="<?= zen_href_link(FILENAME_DEFAULT, 'cPath=' . $cat['categories_id']) ?>"><?= $cat['categories_name'] ?></a>
                            ...
                            <ul>
                                ...
                                foreach ($subcats[$cat_id] as $sub):
                                    ?>
                                    <li class="sub-level"><a href="<?= zen_href_link(FILENAME_DEFAULT, 'cPath=' . $sub['categories_id']) ?>"><?= $sub['categories_name'] ?></a></li>
                        <?php endforeach ?>
                            </ul>
        <?php endif ?>
                    </li>
