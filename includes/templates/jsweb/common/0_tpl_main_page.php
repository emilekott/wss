...
<body id="<?php echo $body_id . 'Body'; ?>"<?php echo ' onload="correctPNG(); '.$zv_onload.'"'; ?>>
...
<div><a href="http://www.witteringsurfshop.com/page.html?id=14"><img src="<?php echo DIR_WS_TEMPLATES . $template_dir; ?>/images/design/signup.jpg" border="0" alt="" /></a></div>
</td>
<?php
}
?>
