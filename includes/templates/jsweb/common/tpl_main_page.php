    ...
    <td valign="top" <?php if(!$flag_disable_left): echo 'id="maincontent"'; endif ?>>
        ...
        <div class="header03">
            ...
            <ul>
                ...
                <li><a class="headerlinks01" href="<?php echo zen_href_link(FILENAME_EZPAGES, 'id=5', 'NONSSL'); ?>">CAFE</a></li>
                <li><a class="headerlinks01" href="<?php echo zen_href_link(FILENAME_SURF_FORECAST, '', 'NONSSL'); ?>">SURF FORECAST</a></li>
                <li><a class="headerlinks01" href="<?php echo zen_href_link(FILENAME_EZPAGES, 'id=19', 'NONSSL'); ?>">HIRE & REPAIR</a></li>
...
<div class="sideBoxContent centeredContent"><a href="http://www.witteringsurfshop.com/page.html?id=14"><img src="<?php echo DIR_WS_TEMPLATES . $template_dir; ?>/images/signup_banner.jpg" border="0" alt="Sign up to our newsletter" /></a>
<br><br>
<iframe src="//www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2Fwitteringsurfshop&amp;width=213&amp;height=290&amp;colorscheme=light&amp;show_faces=true&amp;border_color=%23ffffff&amp;stream=false&amp;header=true&amp;appId=183860935038070" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:213px; height:290px;" allowTransparency="true"></iframe>
</div>
<?php
