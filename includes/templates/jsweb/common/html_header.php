...
<meta name="author" content="Wittering Surf Shop" />
...
/**
 * load stylesheets on a per-page/per-language/per-product/per-manufacturer/per-category basis:
 */
...
// add embedded stylesheet styles, to override components of linked stylesheets:
// in this case, deal specifically with the divider between prices, only if logged in:
if ($_SESSION['customer_id'] != '') {
  echo '<style type="text/css">' . "\n";
  echo '<!--' . "\n";
	echo '.currencyDisplayGBP, .currencyDisplayEUR, .currencyDisplayUSD {border-left: none;  padding-left:0;}'."\n";
  echo '-->' . "\n";
	echo '</style>'."\n";
}
?>
...
<script type="text/javascript">
	function showpopup(popup_name) {      	    
			...
			document.getElementById('menulink').innerHTML = '<a href="#" onclick="hidepopup(\'showmanu\'); return false"><img src="./includes/templates/jsweb/images/design/brand.jpg" border="0" alt="" onmouseover="this.src=\'<?php echo DIR_WS_TEMPLATES . $template_dir;?>/images/design/brand_hover.jpg\'" onmouseout="this.src=\'<?php echo DIR_WS_TEMPLATES . $template_dir;?>/images/design/brand.jpg\'" /></a>';
			}
	function hidepopup(popup_name) {      	    
			document.getElementById(popup_name).style.display = 'none';
			document.getElementById('menulink').innerHTML = '<a href="#" onclick="showpopup(\'showmanu\'); return false"><img src="./includes/templates/jsweb/images/design/brand.jpg" border="0" alt="" onmouseover="this.src=\'<?php echo DIR_WS_TEMPLATES . $template_dir;?>/images/design/brand_hover.jpg\'" onmouseout="this.src=\'<?php echo DIR_WS_TEMPLATES . $template_dir;?>/images/design/brand.jpg\'" /></a>';
            }
