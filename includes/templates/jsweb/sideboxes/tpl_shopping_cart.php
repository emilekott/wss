...
//    }
$content .= '
	<span class="color01">'. $_SESSION['cart']->count_contents() .'</span>&nbsp;Items&nbsp;<span class="color01">'. $currencies->format($_SESSION['cart']->show_total()) .'</span>&nbsp;&nbsp;<a class="sclink" href="' . zen_href_link(FILENAME_SHOPPING_CART, '', 'NONSSL') . '">View Basket</a>&nbsp;|&nbsp;<a class="sclink" href="' . zen_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'NONSSL') . '">Checkout Now</a>';
