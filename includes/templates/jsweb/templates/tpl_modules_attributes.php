...
<div class="back"><img src="<?php echo DIR_WS_TEMPLATES . $template_dir; ?>/images/design/optbg1.jpg" border="0" alt="" /></div><div class="back">
<div id="optionName2" class="back"><?php echo $options_name[$i]; ?>:</div></div>
<div id="optionName2i" class="back"><?php echo "\n" . $options_menu[$i]; ?></div>
<div class="back"><img src="<?php echo DIR_WS_TEMPLATES . $template_dir; ?>/images/design/optbg3.jpg" border="0" alt="" /></div>
<br class="clearBoth" />
</div>
