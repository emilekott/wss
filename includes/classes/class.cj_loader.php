...
class RICJLoader{
	...
	function loadCssJsFiles(){
		global $loaders, $current_page_base, $template, $Ajax, $page_directory, $this_is_home_page, $cPath;
		/**
		...
		if((is_array($loaders)) && count($loaders) > 0)	{
			foreach($loaders as $loader){
				if(in_array('*', $loader['conditions']['pages']) || in_array($current_page_base, $loader['conditions']['pages'])){
	...
	function processCssJsFiles(){
		global $current_page_base, $minify_cache_time_latest, $Ajax;
