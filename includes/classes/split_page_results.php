...
class splitPageResults extends base {
  ...
  function display_links($max_page_links, $parameters = '') {
    ...
    if ($this->current_page_number > 1) $display_links_string .= '<a href="' . zen_href_link($_GET['main_page'], $parameters . $this->page_name . '=' . ($this->current_page_number - 1), $request_type) . '" title=" ' . PREVNEXT_TITLE_PREVIOUS_PAGE . ' " class="page-prevbtn">' . PREVNEXT_BUTTON_PREV . '</a>&nbsp;&nbsp;';
    ...
    // next button
    if (($this->current_page_number < $this->number_of_pages) && ($this->number_of_pages != 1)) $display_links_string .= '&nbsp;<a href="' . zen_href_link($_GET['main_page'], $parameters . 'page=' . ($this->current_page_number + 1), $request_type) . '" title=" ' . PREVNEXT_TITLE_NEXT_PAGE . ' " class="page-nextbtn">' . PREVNEXT_BUTTON_NEXT . '</a>&nbsp;';
