...
if(STORE_COPYRIGHT_OTHER_EN != ''){ $store_copyright_other = STORE_COPYRIGHT_OTHER_EN . '&nbsp;&nbsp;'; }
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . $copyyear . '<a href="' . STORE_COPYRIGHT_URL . '" target="_blank">' . STORE_COPYRIGHT_NAME . '</a>.<br />' . $store_copyright_other . '');
...
// manufacturers box text in sideboxes/manufacturers.php
  define('BOX_HEADING_MANUFACTURERS', 'Shop By:');
...
// information box text in sideboxes/information.php
  define('BOX_HEADING_INFORMATION', 'Site Information');
  define('BOX_INFORMATION_PRIVACY', 'Privacy Notice');
  define('BOX_INFORMATION_CONDITIONS', 'Conditions of Use');
 define('BOX_INFORMATION_SHIPPING', 'Delivery &amp; Returns');
  define('BOX_INFORMATION_CONTACT', 'Contact Us');
    define('BOX_INFORMATION_HELP', 'Help');
...
// javascript messages
 ...
 define('ENTRY_STATE', 'County/Province:');
 ...
 define('ENTRY_STATE_ERROR_SELECT', 'Please select a county from the Counties pull down menu.');
  ...
  define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS', 'Displaying %d-%d of %d by');
...
// IP Address
 define('TEXT_YOUR_IP_ADDRESS','As a security safeguard your IP Address is logged as: ');
