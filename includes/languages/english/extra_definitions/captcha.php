...
define('TITLE_CAPTCHA', 'Verification code:');
define('TEXT_CAPTCHA', '* (case insensitive)');
define('ERROR_CAPTCHA', 'You did not entered the validation code correctly. Please, try again.');
define('BUTTON_IMAGE_CAPTCHA_REDRAW', 'button_redraw.gif');
define('BUTTON_IMAGE_CAPTCHA_REDRAW_ALT', 'Redraw Capture Image');
define('BUTTON_IMAGE_CAPTCHA_REDRAW_TEXT', 'If the image text is not readable use this button to');
