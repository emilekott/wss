...
define('HEADING_TITLE', '<img src="https://www.witteringsurfshop.com/images/yourcart.gif" alt="Your Shopping Cart"><br>');
...
define('TEXT_CART_EMPTY', '<img src="https://www.witteringsurfshop.com/images/emptycart.gif" alt="Your Shopping Cart Is Empty"><br><br>');
...
define('OUT_OF_STOCK_CAN_CHECKOUT', 'Sorry but products marked with ' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' do not have enough stock.<br />Please adjust the quantity and click <strong>Update Basket</strong>.');
