...
if (STORE_STATUS == '0') {
  ...
  define('TEXT_GREETING_GUEST', 'Welcome, we hope you enjoy your visit to Wittering Surf Shop');
}

define('TEXT_GREETING_PERSONAL', 'Hello <span class="greetUser">%s</span>! Would you like to see our <a href="%s">Lewest Additions</a>?');
