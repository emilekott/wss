...
define('HEADING_TITLE', '<img src="https://www.witteringsurfshop.com/images/welcome-signuplogin.gif" alt="Welcome, Sign Up or Log In"><br><br>');
...
define('TEXT_NEW_CUSTOMER_POST_INTRODUCTION_SPLIT', '<strong>Welcome to Wittering Surf Shop.</strong><p><br>Creating an account takes just a few moments. You will be able to store your billing and delivery details for future orders. And take advantage of our other Member Benefits.</p>');
...
define('TEXT_RETURNING_CUSTOMER_SPLIT', '<strong>Welcome Back!</strong><p><br>Please login using your email address and password below:</p>');
