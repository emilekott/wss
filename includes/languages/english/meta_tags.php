...
// page title
define('TITLE', 'Wittering Surf Shop');

// Site Tagline
define('SITE_TAGLINE', 'UK Premier Shop, East Wittering Specialists In Quality Wetsuits and Surfboards');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'surf, wittering, online, surfing, surfboard, wetsuit, clothing, fashion. hardware, shop, online shopping');
