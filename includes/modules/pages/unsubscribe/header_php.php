...
// BEGIN newsletter_subscribe mod 2/3
    ...
    // initial goodbye
			...
			(strlen(NEWSONLY_SUBSCRIPTION_CC) > 4)) {
				...
				$email_text = 'Nieuwsbrief uitschrijving van email adres: ' . $unsubscribe_address . "\n" .
											'verwijderd op ' . strftime(DATE_FORMAT_LONG) . '.';
				mail(EMAIL_FROM, 'Nieuwsbrief uitschrijving Notification', $email_text, "From: ".STORE_NAME."\r\nReply-to: ".EMAIL_FROM."\r\n");
			}
  } else {
