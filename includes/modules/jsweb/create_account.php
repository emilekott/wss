...
// END newsletter_subscribe mod 1/1
     ...
     */
     ...
     if($newsletter):
        $sub_attempt1 = $mailchimp_api->listSubscribe('bde7df6000',$email_address,array('FNAME'=>$firstname,'LNAME'=>$lastname)); //customer list subscribe
        //$sub_attempt2 = $mailchimp_api->listSubscribe('7ef0a7fb12',$email_address,''); //newsletter list subscribe
     endif;
    /*
