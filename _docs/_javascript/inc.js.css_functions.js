// $Id: inc.js.css_functions.js 382 2009-06-22 18:49:29Z Bob $

/**
 * Looks for the very last occurrence (and therefore most significant) of a specified CSS style in
 * the current document. Checks every stylesheet, including imported stylesheets. An optional media
 * type can be specified to limit the search to that media type only.
 *
 * @author Conor Kerr
 * @copyright 2008-2009 Ceon (http://ceon.net)
...
function CeonSearchStyleSheetForCSSStyleRule(ss, selector, media)
{
	...
	if (ss.imports) {
		// IE
		// IE doesn't support specifying media after import statement and lumps all CSS Rules (inc
		// Media Rules) into same media as main stylesheet
